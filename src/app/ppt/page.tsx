      ...
      <header className="tool-header h-16 px-6 border-b border-slate-700/60 flex items-center justify-between shrink-0 z-40 bg-slate-900/50 backdrop-blur-md">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400">Sutmuch PPT 创作台</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-all shadow-sm active:scale-95 border ${
              isStylePanelOpen ? 'bg-indigo-500/20 border-indigo-500/50 text-indigo-300' : 'bg-slate-800 border-slate-700 text-slate-300 hover:bg-slate-700 hover:text-white hover:border-slate-600'
            }`}
            title="风格设置"
          >
            🎛️
          ...
          <button onClick={handleLogout} className="p-2 text-slate-400 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors" title="退出登录">
